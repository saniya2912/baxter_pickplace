...
|------|-----------|---------|----------------|-------------|--------|
| 0 red → far | 7/10 | 0/10 | 1/10 | 6/10 | 9/10 |
| 1 red → near | 2/10 | 0/10 | 2/10 | 4/10 | 4/10 |
| 2 blue → far | 0/10 | 0/10 | 8/10 | 7/10 | 9/10 |
| 3 blue → near | 0/10 | 0/10 | 0/10 | 5/10 | 4/10 |
| 4 green → far | 0/10 | N/A | 1/10 | 2/10 | 0/10 |
| 5 green → near | 0/10 | N/A | 0/10 | 0/10 | 0/10 |
| **Total** | **9/60** | **0/40** | **12/60** | **24/60** | **26/60** |

### Direction Accuracy (% of trials where block moved correct direction)

| Task | pi05_base | vel 99k | pos_run3 199k | pos_v2 499k | pos_v3 |
|------|-----------|---------|----------------|-------------|--------|
| 0 red → far | 100% | 0% | 50% | 100% | 100% |
| 1 red → near | 40% | 0% | 50% | 40% | 40% |
| 2 blue → far | 20% | 0% | 80% | 100% | 90% |
| 3 blue → near | 0% | 0% | 0% | 50% | 40% |
| 4 green → far | 10% | N/A | 50% | 80% | 0% |
| 5 green → near | 0% | N/A | 0% | 0% | 0% |

### Block Lifted (% of trials where true pick-and-place occurred)

| Task | pi05_base | vel 99k | pos_run3 199k | pos_v2 499k | pos_v3 |
|------|-----------|---------|----------------|-------------|--------|
| 0 red → far | 80% | 0% | 20% | 70% | 90% |
| 1 red → near | 20% | 0% | 30% | 50% | 70% |
| 2 blue → far | 0% | 0% | 30% | 90% | 80% |
| 3 blue → near | 0% | 0% | 30% | 60% | 70% |
| 4 green → far | 0% | N/A | 10% | 30% | 0% |
| 5 green → near | 0% | N/A | 10% | 0% | 0% |

### Mean Block Displacement (m, signed — positive = moved far)

| Task | pi05_base | vel 99k | pos_run3 199k | pos_v2 499k | pos_v3 |
|------|-----------|---------|----------------|-------------|--------|
| 0 red → far | +0.127 | +0.000 | +0.022 | +0.116 | +0.159 |
| 1 red → near | -0.015 | +0.000 | -0.020 | -0.031 | -0.022 |
| 2 blue → far | +0.003 | +0.000 | +0.128 | +0.126 | +0.121 |
| 3 blue → near | +0.001 | +0.000 | +0.054 | -0.056 | -0.024 |
| 4 green → far | -0.000 | N/A | +0.022 | +0.063 | +0.000 |
| 5 green → near | +0.000 | N/A | +0.033 | +0.005 | +0.000 |

### Mean Gripper Close Step

| Task | pi05_base | vel 99k | pos_run3 199k | pos_v2 499k | pos_v3 |
|------|-----------|---------|----------------|-------------|--------|
| 0 red → far | 69 | 762 | 73 | 76 | 36 |
| 1 red → near | 77 | 940 | 110 | 114 | 64 |
| 2 blue → far | 4 | 179 | 195 | 254 | 157 |
| 3 blue → near | 5 | 183 | 166 | 147 | 154 |
| 4 green → far | 4 | N/A | 92 | 74 | 51 |
| 5 green → near | 4 | N/A | 81 | 90 | 60 |
