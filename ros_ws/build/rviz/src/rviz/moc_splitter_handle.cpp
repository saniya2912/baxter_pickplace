...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_rviz__SplitterHandle_t, stringdata) + ofs \
...
const QMetaObject rviz::SplitterHandle::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_rviz__SplitterHandle.data,
      qt_meta_data_rviz__SplitterHandle,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_rviz__SplitterHandle.stringdata))
