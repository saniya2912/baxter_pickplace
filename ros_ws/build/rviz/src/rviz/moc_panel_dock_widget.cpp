...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_rviz__PanelDockWidget_t, stringdata) + ofs \
...
const QMetaObject rviz::PanelDockWidget::staticMetaObject = {
    { &QDockWidget::staticMetaObject, qt_meta_stringdata_rviz__PanelDockWidget.data,
      qt_meta_data_rviz__PanelDockWidget,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_rviz__PanelDockWidget.stringdata))
