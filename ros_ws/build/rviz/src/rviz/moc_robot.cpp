...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_rviz__Robot_t, stringdata) + ofs \
...
QT_MOC_LITERAL(6, 99, 24),
QT_MOC_LITERAL(7, 124, 25)
    },
...
const QMetaObject rviz::Robot::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_rviz__Robot.data,
      qt_meta_data_rviz__Robot,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_rviz__Robot.stringdata))
