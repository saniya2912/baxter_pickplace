...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_rviz__StatusProperty_t, stringdata) + ofs \
...
const QMetaObject rviz::StatusProperty::staticMetaObject = {
    { &Property::staticMetaObject, qt_meta_stringdata_rviz__StatusProperty.data,
      qt_meta_data_rviz__StatusProperty,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_rviz__StatusProperty.stringdata))
