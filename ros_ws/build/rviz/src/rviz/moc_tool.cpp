...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_rviz__Tool_t, stringdata) + ofs \
...
void rviz::Tool::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Tool::close)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject rviz::Tool::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_rviz__Tool.data,
      qt_meta_data_rviz__Tool,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_rviz__Tool.stringdata))
