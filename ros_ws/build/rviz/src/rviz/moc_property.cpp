...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_rviz__Property_t, stringdata) + ofs \
...
QT_MOC_LITERAL(6, 65, 13)
    ...
    "childListChanged\0Property*\0this_property\0"
};
...
const QMetaObject rviz::Property::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_rviz__Property.data,
      qt_meta_data_rviz__Property,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_rviz__Property.stringdata))
