...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_rviz___RosTopicDisplay_t, stringdata) + ofs \
...
const QMetaObject rviz::_RosTopicDisplay::staticMetaObject = {
    { &Display::staticMetaObject, qt_meta_stringdata_rviz___RosTopicDisplay.data,
      qt_meta_data_rviz___RosTopicDisplay,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_rviz___RosTopicDisplay.stringdata))
