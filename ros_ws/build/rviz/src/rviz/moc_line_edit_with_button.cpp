...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_rviz__LineEditWithButton_t, stringdata) + ofs \
...
const QMetaObject rviz::LineEditWithButton::staticMetaObject = {
    { &QLineEdit::staticMetaObject, qt_meta_stringdata_rviz__LineEditWithButton.data,
      qt_meta_data_rviz__LineEditWithButton,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_rviz__LineEditWithButton.stringdata))
