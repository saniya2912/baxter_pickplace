...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_rviz__TfFrameProperty_t, stringdata) + ofs \
...
const QMetaObject rviz::TfFrameProperty::staticMetaObject = {
    { &EditableEnumProperty::staticMetaObject, qt_meta_stringdata_rviz__TfFrameProperty.data,
      qt_meta_data_rviz__TfFrameProperty,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_rviz__TfFrameProperty.stringdata))
