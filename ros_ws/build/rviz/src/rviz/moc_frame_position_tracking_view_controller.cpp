...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_rviz__FramePositionTrackingViewController_t, stringdata) + ofs \
...
const QMetaObject rviz::FramePositionTrackingViewController::staticMetaObject = {
    { &ViewController::staticMetaObject, qt_meta_stringdata_rviz__FramePositionTrackingViewController.data,
      qt_meta_data_rviz__FramePositionTrackingViewController,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_rviz__FramePositionTrackingViewController.stringdata))
