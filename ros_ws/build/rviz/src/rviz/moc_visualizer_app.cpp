...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_rviz__VisualizerApp_t, stringdata) + ofs \
...
QT_MOC_LITERAL(2, 34, 0)
    ...
    "rviz::VisualizerApp\0checkContinue\0\0"
};
...
const QMetaObject rviz::VisualizerApp::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_rviz__VisualizerApp.data,
      qt_meta_data_rviz__VisualizerApp,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_rviz__VisualizerApp.stringdata))
