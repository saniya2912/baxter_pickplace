...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_rviz__EditableEnumProperty_t, stringdata) + ofs \
...
QT_MOC_LITERAL(5, 93, 9),
QT_MOC_LITERAL(6, 103, 3)
    },
...
const QMetaObject rviz::EditableEnumProperty::staticMetaObject = {
    { &StringProperty::staticMetaObject, qt_meta_stringdata_rviz__EditableEnumProperty.data,
      qt_meta_data_rviz__EditableEnumProperty,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_rviz__EditableEnumProperty.stringdata))
