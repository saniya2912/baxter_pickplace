...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_rviz__SplashScreen_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 32, 7)
    ...
    "rviz::SplashScreen\0showMessage\0\0message\0"
};
...
const QMetaObject rviz::SplashScreen::staticMetaObject = {
    { &QSplashScreen::staticMetaObject, qt_meta_stringdata_rviz__SplashScreen.data,
      qt_meta_data_rviz__SplashScreen,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_rviz__SplashScreen.stringdata))
