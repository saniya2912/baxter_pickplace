...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_rviz__Panel_t, stringdata) + ofs \
...
const QMetaObject rviz::Panel::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_rviz__Panel.data,
      qt_meta_data_rviz__Panel,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_rviz__Panel.stringdata))
