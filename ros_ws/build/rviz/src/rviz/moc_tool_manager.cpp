...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_rviz__ToolManager_t, stringdata) + ofs \
...
QT_MOC_LITERAL(11, 131, 9)
    ...
    "Property*\0property\0closeTool\0"
};
...
const QMetaObject rviz::ToolManager::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_rviz__ToolManager.data,
      qt_meta_data_rviz__ToolManager,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_rviz__ToolManager.stringdata))
