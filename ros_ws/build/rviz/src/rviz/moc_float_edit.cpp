...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_rviz__FloatEdit_t, stringdata) + ofs \
...
const QMetaObject rviz::FloatEdit::staticMetaObject = {
    { &QLineEdit::staticMetaObject, qt_meta_stringdata_rviz__FloatEdit.data,
      qt_meta_data_rviz__FloatEdit,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_rviz__FloatEdit.stringdata))
