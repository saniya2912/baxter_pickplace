...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_rviz__LoadingDialog_t, stringdata) + ofs \
...
const QMetaObject rviz::LoadingDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_rviz__LoadingDialog.data,
      qt_meta_data_rviz__LoadingDialog,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_rviz__LoadingDialog.stringdata))
