...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_rviz__VectorProperty_t, stringdata) + ofs \
...
const QMetaObject rviz::VectorProperty::staticMetaObject = {
    { &Property::staticMetaObject, qt_meta_stringdata_rviz__VectorProperty.data,
      qt_meta_data_rviz__VectorProperty,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_rviz__VectorProperty.stringdata))
