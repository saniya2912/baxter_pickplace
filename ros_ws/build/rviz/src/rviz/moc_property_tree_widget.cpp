...
const QMetaObject rviz::PropertyTreeWidget::staticMetaObject = {
    { &QTreeView::staticMetaObject, qt_meta_stringdata_rviz__PropertyTreeWidget.data,
      qt_meta_data_rviz__PropertyTreeWidget,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_rviz__PropertyTreeWidget.stringdata))
