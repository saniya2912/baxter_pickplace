...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_rviz__FrameManager_t, stringdata) + ofs \
...
const QMetaObject rviz::FrameManager::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_rviz__FrameManager.data,
      qt_meta_data_rviz__FrameManager,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_rviz__FrameManager.stringdata))
