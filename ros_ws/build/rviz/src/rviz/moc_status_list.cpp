...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_rviz__StatusList_t, stringdata) + ofs \
...
const QMetaObject rviz::StatusList::staticMetaObject = {
    { &StatusProperty::staticMetaObject, qt_meta_stringdata_rviz__StatusList.data,
      qt_meta_data_rviz__StatusList,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_rviz__StatusList.stringdata))
