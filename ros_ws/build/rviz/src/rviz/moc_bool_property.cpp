...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_rviz__BoolProperty_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 28, 5)
    ...
    "rviz::BoolProperty\0setBool\0\0value\0"
};
...
const QMetaObject rviz::BoolProperty::staticMetaObject = {
    { &Property::staticMetaObject, qt_meta_stringdata_rviz__BoolProperty.data,
      qt_meta_data_rviz__BoolProperty,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_rviz__BoolProperty.stringdata))
