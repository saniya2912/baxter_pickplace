...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_rviz__ScreenshotDialog_t, stringdata) + ofs \
...
const QMetaObject rviz::ScreenshotDialog::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_rviz__ScreenshotDialog.data,
      qt_meta_data_rviz__ScreenshotDialog,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_rviz__ScreenshotDialog.stringdata))
