...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_rviz__DisplaysPanel_t, stringdata) + ofs \
...
const QMetaObject rviz::DisplaysPanel::staticMetaObject = {
    { &Panel::staticMetaObject, qt_meta_stringdata_rviz__DisplaysPanel.data,
      qt_meta_data_rviz__DisplaysPanel,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_rviz__DisplaysPanel.stringdata))
