...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_rviz__SelectionPanel_t, stringdata) + ofs \
...
const QMetaObject rviz::SelectionPanel::staticMetaObject = {
    { &Panel::staticMetaObject, qt_meta_stringdata_rviz__SelectionPanel.data,
      qt_meta_data_rviz__SelectionPanel,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_rviz__SelectionPanel.stringdata))
