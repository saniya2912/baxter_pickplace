...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_rviz__ViewController_t, stringdata) + ofs \
...
const QMetaObject rviz::ViewController::staticMetaObject = {
    { &Property::staticMetaObject, qt_meta_stringdata_rviz__ViewController.data,
      qt_meta_data_rviz__ViewController,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_rviz__ViewController.stringdata))
