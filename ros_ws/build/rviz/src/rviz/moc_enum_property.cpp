...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_rviz__EnumProperty_t, stringdata) + ofs \
...
QT_MOC_LITERAL(5, 77, 9),
QT_MOC_LITERAL(6, 87, 3),
...
const QMetaObject rviz::EnumProperty::staticMetaObject = {
    { &StringProperty::staticMetaObject, qt_meta_stringdata_rviz__EnumProperty.data,
      qt_meta_data_rviz__EnumProperty,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_rviz__EnumProperty.stringdata))
