...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_rviz__DisplayGroupVisibilityProperty_t, stringdata) + ofs \
...
const QMetaObject rviz::DisplayGroupVisibilityProperty::staticMetaObject = {
    { &DisplayVisibilityProperty::staticMetaObject, qt_meta_stringdata_rviz__DisplayGroupVisibilityProperty.data,
      qt_meta_data_rviz__DisplayGroupVisibilityProperty,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_rviz__DisplayGroupVisibilityProperty.stringdata))
