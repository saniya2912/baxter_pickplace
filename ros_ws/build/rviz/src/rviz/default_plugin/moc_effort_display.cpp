...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_rviz__JointInfo_t, stringdata) + ofs \
...
const QMetaObject rviz::JointInfo::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_rviz__JointInfo.data,
      qt_meta_data_rviz__JointInfo,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_rviz__JointInfo.stringdata))
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_rviz__EffortDisplay_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
...
QT_MOC_LITERAL(3, 41, 19),
QT_MOC_LITERAL(4, 61, 22),
QT_MOC_LITERAL(5, 84, 12),
QT_MOC_LITERAL(6, 97, 10),
...
const QMetaObject rviz::EffortDisplay::staticMetaObject = {
    { &rviz::MessageFilterJointStateDisplay::staticMetaObject, qt_meta_stringdata_rviz__EffortDisplay.data,
      qt_meta_data_rviz__EffortDisplay,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_rviz__EffortDisplay.stringdata))
