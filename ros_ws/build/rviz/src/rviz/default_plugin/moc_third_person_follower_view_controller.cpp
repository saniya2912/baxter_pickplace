...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_rviz__ThirdPersonFollowerViewController_t, stringdata) + ofs \
...
const QMetaObject rviz::ThirdPersonFollowerViewController::staticMetaObject = {
    { &OrbitViewController::staticMetaObject, qt_meta_stringdata_rviz__ThirdPersonFollowerViewController.data,
      qt_meta_data_rviz__ThirdPersonFollowerViewController,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_rviz__ThirdPersonFollowerViewController.stringdata))
