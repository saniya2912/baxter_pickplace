...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_rviz__RosFilteredTopicProperty_t, stringdata) + ofs \
...
const QMetaObject rviz::RosFilteredTopicProperty::staticMetaObject = {
    { &RosTopicProperty::staticMetaObject, qt_meta_stringdata_rviz__RosFilteredTopicProperty.data,
      qt_meta_data_rviz__RosFilteredTopicProperty,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_rviz__RosFilteredTopicProperty.stringdata))
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_rviz__DepthCloudDisplay_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
...
QT_MOC_LITERAL(7, 100, 17),
QT_MOC_LITERAL(8, 118, 17),
QT_MOC_LITERAL(9, 136, 20),
QT_MOC_LITERAL(10, 157, 30),
QT_MOC_LITERAL(11, 188, 22)
    },
...
const QMetaObject rviz::DepthCloudDisplay::staticMetaObject = {
    { &rviz::Display::staticMetaObject, qt_meta_stringdata_rviz__DepthCloudDisplay.data,
      qt_meta_data_rviz__DepthCloudDisplay,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_rviz__DepthCloudDisplay.stringdata))
