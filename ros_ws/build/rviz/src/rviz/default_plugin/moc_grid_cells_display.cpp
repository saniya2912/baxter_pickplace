...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_rviz__GridCellsDisplay_t, stringdata) + ofs \
...
const QMetaObject rviz::GridCellsDisplay::staticMetaObject = {
    { &Display::staticMetaObject, qt_meta_stringdata_rviz__GridCellsDisplay.data,
      qt_meta_data_rviz__GridCellsDisplay,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_rviz__GridCellsDisplay.stringdata))
