...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_rviz__ImageDisplay_t, stringdata) + ofs \
...
const QMetaObject rviz::ImageDisplay::staticMetaObject = {
    { &ImageDisplayBase::staticMetaObject, qt_meta_stringdata_rviz__ImageDisplay.data,
      qt_meta_data_rviz__ImageDisplay,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_rviz__ImageDisplay.stringdata))
