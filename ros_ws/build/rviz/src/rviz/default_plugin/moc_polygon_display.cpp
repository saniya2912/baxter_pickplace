...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_rviz__PolygonDisplay_t, stringdata) + ofs \
...
const QMetaObject rviz::PolygonDisplay::staticMetaObject = {
    { &MessageFilterDisplay<geometry_msgs::PolygonStamped>::staticMetaObject, qt_meta_stringdata_rviz__PolygonDisplay.data,
      qt_meta_data_rviz__PolygonDisplay,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_rviz__PolygonDisplay.stringdata))
