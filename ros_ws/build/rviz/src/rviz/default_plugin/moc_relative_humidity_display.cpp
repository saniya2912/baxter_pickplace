...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_rviz__RelativeHumidityDisplay_t, stringdata) + ofs \
...
const QMetaObject rviz::RelativeHumidityDisplay::staticMetaObject = {
    { &MessageFilterDisplay<sensor_msgs::RelativeHumidity>::staticMetaObject, qt_meta_stringdata_rviz__RelativeHumidityDisplay.data,
      qt_meta_data_rviz__RelativeHumidityDisplay,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_rviz__RelativeHumidityDisplay.stringdata))
