...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_rviz__IntegerAction_t, stringdata) + ofs \
...
void rviz::IntegerAction::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&IntegerAction::triggered)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject rviz::IntegerAction::staticMetaObject = {
    { &QAction::staticMetaObject, qt_meta_stringdata_rviz__IntegerAction.data,
      qt_meta_data_rviz__IntegerAction,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_rviz__IntegerAction.stringdata))
