...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_rviz__TFDisplay_t, stringdata) + ofs \
...
const QMetaObject rviz::TFDisplay::staticMetaObject = {
    { &Display::staticMetaObject, qt_meta_stringdata_rviz__TFDisplay.data,
      qt_meta_data_rviz__TFDisplay,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_rviz__TFDisplay.stringdata))
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_rviz__FrameInfo_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
...
const QMetaObject rviz::FrameInfo::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_rviz__FrameInfo.data,
      qt_meta_data_rviz__FrameInfo,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_rviz__FrameInfo.stringdata))
