...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_rviz__IntensityPCTransformer_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 47, 32)
    ...
    "updateUseRainbow\0\0updateAutoComputeIntensityBounds\0"
};
...
const QMetaObject rviz::IntensityPCTransformer::staticMetaObject = {
    { &PointCloudTransformer::staticMetaObject, qt_meta_stringdata_rviz__IntensityPCTransformer.data,
      qt_meta_data_rviz__IntensityPCTransformer,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_rviz__IntensityPCTransformer.stringdata))
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_rviz__XYZPCTransformer_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
...
const QMetaObject rviz::XYZPCTransformer::staticMetaObject = {
    { &PointCloudTransformer::staticMetaObject, qt_meta_stringdata_rviz__XYZPCTransformer.data,
      qt_meta_data_rviz__XYZPCTransformer,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_rviz__XYZPCTransformer.stringdata))
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_rviz__RGB8PCTransformer_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
...
const QMetaObject rviz::RGB8PCTransformer::staticMetaObject = {
    { &PointCloudTransformer::staticMetaObject, qt_meta_stringdata_rviz__RGB8PCTransformer.data,
      qt_meta_data_rviz__RGB8PCTransformer,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_rviz__RGB8PCTransformer.stringdata))
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_rviz__MONO8PCTransformer_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
...
const QMetaObject rviz::MONO8PCTransformer::staticMetaObject = {
    { &RGB8PCTransformer::staticMetaObject, qt_meta_stringdata_rviz__MONO8PCTransformer.data,
      qt_meta_data_rviz__MONO8PCTransformer,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_rviz__MONO8PCTransformer.stringdata))
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_rviz__RGBF32PCTransformer_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
...
const QMetaObject rviz::RGBF32PCTransformer::staticMetaObject = {
    { &PointCloudTransformer::staticMetaObject, qt_meta_stringdata_rviz__RGBF32PCTransformer.data,
      qt_meta_data_rviz__RGBF32PCTransformer,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_rviz__RGBF32PCTransformer.stringdata))
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_rviz__FlatColorPCTransformer_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
...
const QMetaObject rviz::FlatColorPCTransformer::staticMetaObject = {
    { &PointCloudTransformer::staticMetaObject, qt_meta_stringdata_rviz__FlatColorPCTransformer.data,
      qt_meta_data_rviz__FlatColorPCTransformer,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_rviz__FlatColorPCTransformer.stringdata))
...
const QMetaObject rviz::AxisColorPCTransformer::staticMetaObject = {
    { &PointCloudTransformer::staticMetaObject, qt_meta_stringdata_rviz__AxisColorPCTransformer.data,
      qt_meta_data_rviz__AxisColorPCTransformer,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_rviz__AxisColorPCTransformer.stringdata))
