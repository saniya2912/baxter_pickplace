...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_rviz__OdometryDisplay_t, stringdata) + ofs \
...
const QMetaObject rviz::OdometryDisplay::staticMetaObject = {
    { &rviz::MessageFilterDisplay<nav_msgs::Odometry>::staticMetaObject, qt_meta_stringdata_rviz__OdometryDisplay.data,
      qt_meta_data_rviz__OdometryDisplay,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_rviz__OdometryDisplay.stringdata))
