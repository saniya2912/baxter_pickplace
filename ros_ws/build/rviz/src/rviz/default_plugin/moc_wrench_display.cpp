...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_rviz__WrenchStampedDisplay_t, stringdata) + ofs \
...
const QMetaObject rviz::WrenchStampedDisplay::staticMetaObject = {
    { &rviz::MessageFilterDisplay<geometry_msgs::WrenchStamped>::staticMetaObject, qt_meta_stringdata_rviz__WrenchStampedDisplay.data,
      qt_meta_data_rviz__WrenchStampedDisplay,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_rviz__WrenchStampedDisplay.stringdata))
