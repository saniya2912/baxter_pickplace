...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_rviz__PoseArrayDisplay_t, stringdata) + ofs \
...
QT_MOC_LITERAL(6, 103, 18)
    ...
    "updateArrow3dGeometry\0updateAxesGeometry\0"
};
...
const QMetaObject rviz::PoseArrayDisplay::staticMetaObject = {
    { &MessageFilterDisplay<geometry_msgs::PoseArray>::staticMetaObject, qt_meta_stringdata_rviz__PoseArrayDisplay.data,
      qt_meta_data_rviz__PoseArrayDisplay,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_rviz__PoseArrayDisplay.stringdata))
