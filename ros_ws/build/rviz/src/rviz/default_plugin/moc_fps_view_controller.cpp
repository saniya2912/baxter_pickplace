...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_rviz__FPSViewController_t, stringdata) + ofs \
...
const QMetaObject rviz::FPSViewController::staticMetaObject = {
    { &FramePositionTrackingViewController::staticMetaObject, qt_meta_stringdata_rviz__FPSViewController.data,
      qt_meta_data_rviz__FPSViewController,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_rviz__FPSViewController.stringdata))
