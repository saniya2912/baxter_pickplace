...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_rviz__PointCloud2Display_t, stringdata) + ofs \
...
const QMetaObject rviz::PointCloud2Display::staticMetaObject = {
    { &MessageFilterDisplay<sensor_msgs::PointCloud2>::staticMetaObject, qt_meta_stringdata_rviz__PointCloud2Display.data,
      qt_meta_data_rviz__PointCloud2Display,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_rviz__PointCloud2Display.stringdata))
