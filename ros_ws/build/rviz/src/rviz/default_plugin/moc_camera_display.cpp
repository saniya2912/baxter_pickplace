...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_rviz__CameraDisplay_t, stringdata) + ofs \
...
const QMetaObject rviz::CameraDisplay::staticMetaObject = {
    { &ImageDisplayBase::staticMetaObject, qt_meta_stringdata_rviz__CameraDisplay.data,
      qt_meta_data_rviz__CameraDisplay,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_rviz__CameraDisplay.stringdata))
