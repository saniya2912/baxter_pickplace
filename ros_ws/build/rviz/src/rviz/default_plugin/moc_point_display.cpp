...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_rviz__PointStampedDisplay_t, stringdata) + ofs \
...
const QMetaObject rviz::PointStampedDisplay::staticMetaObject = {
    { &rviz::MessageFilterDisplay<geometry_msgs::PointStamped>::staticMetaObject, qt_meta_stringdata_rviz__PointStampedDisplay.data,
      qt_meta_data_rviz__PointStampedDisplay,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_rviz__PointStampedDisplay.stringdata))
