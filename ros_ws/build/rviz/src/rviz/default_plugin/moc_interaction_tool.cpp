...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_rviz__InteractionTool_t, stringdata) + ofs \
...
const QMetaObject rviz::InteractionTool::staticMetaObject = {
    { &Tool::staticMetaObject, qt_meta_stringdata_rviz__InteractionTool.data,
      qt_meta_data_rviz__InteractionTool,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_rviz__InteractionTool.stringdata))
