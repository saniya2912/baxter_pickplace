...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_rviz__RobotModelDisplay_t, stringdata) + ofs \
...
QT_MOC_LITERAL(4, 68, 14),
QT_MOC_LITERAL(5, 83, 11),
QT_MOC_LITERAL(6, 95, 22)
    },
...
const QMetaObject rviz::RobotModelDisplay::staticMetaObject = {
    { &Display::staticMetaObject, qt_meta_stringdata_rviz__RobotModelDisplay.data,
      qt_meta_data_rviz__RobotModelDisplay,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_rviz__RobotModelDisplay.stringdata))
