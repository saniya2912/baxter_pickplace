...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_rviz__PointTool_t, stringdata) + ofs \
...
const QMetaObject rviz::PointTool::staticMetaObject = {
    { &Tool::staticMetaObject, qt_meta_stringdata_rviz__PointTool.data,
      qt_meta_data_rviz__PointTool,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_rviz__PointTool.stringdata))
