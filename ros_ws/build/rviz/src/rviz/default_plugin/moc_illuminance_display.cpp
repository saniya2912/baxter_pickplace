...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_rviz__IlluminanceDisplay_t, stringdata) + ofs \
...
const QMetaObject rviz::IlluminanceDisplay::staticMetaObject = {
    { &MessageFilterDisplay<sensor_msgs::Illuminance>::staticMetaObject, qt_meta_stringdata_rviz__IlluminanceDisplay.data,
      qt_meta_data_rviz__IlluminanceDisplay,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_rviz__IlluminanceDisplay.stringdata))
