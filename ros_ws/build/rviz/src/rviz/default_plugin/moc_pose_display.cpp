...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_rviz__PoseDisplay_t, stringdata) + ofs \
...
const QMetaObject rviz::PoseDisplay::staticMetaObject = {
    { &MessageFilterDisplay<geometry_msgs::PoseStamped>::staticMetaObject, qt_meta_stringdata_rviz__PoseDisplay.data,
      qt_meta_data_rviz__PoseDisplay,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_rviz__PoseDisplay.stringdata))
