...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_rviz__PathDisplay_t, stringdata) + ofs \
...
QT_MOC_LITERAL(9, 139, 23)
    ...
    "updatePoseArrowColor\0updatePoseArrowGeometry\0"
};
...
const QMetaObject rviz::PathDisplay::staticMetaObject = {
    { &MessageFilterDisplay<nav_msgs::Path>::staticMetaObject, qt_meta_stringdata_rviz__PathDisplay.data,
      qt_meta_data_rviz__PathDisplay,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_rviz__PathDisplay.stringdata))
