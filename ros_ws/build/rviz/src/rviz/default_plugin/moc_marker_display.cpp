...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_rviz__MarkerDisplay_t, stringdata) + ofs \
...
const QMetaObject rviz::MarkerDisplay::staticMetaObject = {
    { &Display::staticMetaObject, qt_meta_stringdata_rviz__MarkerDisplay.data,
      qt_meta_data_rviz__MarkerDisplay,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_rviz__MarkerDisplay.stringdata))
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_rviz__MarkerNamespace_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
...
const QMetaObject rviz::MarkerNamespace::staticMetaObject = {
    { &BoolProperty::staticMetaObject, qt_meta_stringdata_rviz__MarkerNamespace.data,
      qt_meta_data_rviz__MarkerNamespace,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_rviz__MarkerNamespace.stringdata))
