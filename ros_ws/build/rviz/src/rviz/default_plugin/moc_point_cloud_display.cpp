...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_rviz__PointCloudDisplay_t, stringdata) + ofs \
...
const QMetaObject rviz::PointCloudDisplay::staticMetaObject = {
    { &MessageFilterDisplay<sensor_msgs::PointCloud>::staticMetaObject, qt_meta_stringdata_rviz__PointCloudDisplay.data,
      qt_meta_data_rviz__PointCloudDisplay,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_rviz__PointCloudDisplay.stringdata))
