...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_rviz__PoseWithCovarianceDisplay_t, stringdata) + ofs \
...
QT_MOC_LITERAL(1, 32, 21),
QT_MOC_LITERAL(2, 54, 0),
QT_MOC_LITERAL(3, 55, 19),
QT_MOC_LITERAL(4, 75, 17),
QT_MOC_LITERAL(5, 93, 18),
QT_MOC_LITERAL(6, 112, 19)
    },
    "rviz::PoseWithCovarianceDisplay\0"
    "updateShapeVisibility\0\0updateColorAndAlpha\0"
    "updateShapeChoice\0updateAxisGeometry\0"
    "updateArrowGeometry\0"
};
...
const QMetaObject rviz::PoseWithCovarianceDisplay::staticMetaObject = {
    { &rviz::MessageFilterDisplay<geometry_msgs::PoseWithCovarianceStamped>::staticMetaObject, qt_meta_stringdata_rviz__PoseWithCovarianceDisplay.data,
      qt_meta_data_rviz__PoseWithCovarianceDisplay,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_rviz__PoseWithCovarianceDisplay.stringdata))
