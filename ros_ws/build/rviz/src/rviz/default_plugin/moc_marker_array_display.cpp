...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_rviz__MarkerArrayDisplay_t, stringdata) + ofs \
...
const QMetaObject rviz::MarkerArrayDisplay::staticMetaObject = {
    { &MarkerDisplay::staticMetaObject, qt_meta_stringdata_rviz__MarkerArrayDisplay.data,
      qt_meta_data_rviz__MarkerArrayDisplay,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_rviz__MarkerArrayDisplay.stringdata))
