...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_rviz__ColorProperty_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 30, 5)
    ...
    "rviz::ColorProperty\0setColor\0\0color\0"
};
...
const QMetaObject rviz::ColorProperty::staticMetaObject = {
    { &Property::staticMetaObject, qt_meta_stringdata_rviz__ColorProperty.data,
      qt_meta_data_rviz__ColorProperty,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_rviz__ColorProperty.stringdata))
