...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_rviz__IntProperty_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 26, 9)
    ...
    "rviz::IntProperty\0setInt\0\0new_value\0"
};
...
const QMetaObject rviz::IntProperty::staticMetaObject = {
    { &Property::staticMetaObject, qt_meta_stringdata_rviz__IntProperty.data,
      qt_meta_data_rviz__IntProperty,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_rviz__IntProperty.stringdata))
