...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_rviz__StringProperty_t, stringdata) + ofs \
...
QT_MOC_LITERAL(6, 61, 7)
    ...
    "setStdString\0std::string\0std_str\0"
};
...
const QMetaObject rviz::StringProperty::staticMetaObject = {
    { &Property::staticMetaObject, qt_meta_stringdata_rviz__StringProperty.data,
      qt_meta_data_rviz__StringProperty,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_rviz__StringProperty.stringdata))
