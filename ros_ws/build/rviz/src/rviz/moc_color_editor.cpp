...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_rviz__ColorEditor_t, stringdata) + ofs \
...
const QMetaObject rviz::ColorEditor::staticMetaObject = {
    { &LineEditWithButton::staticMetaObject, qt_meta_stringdata_rviz__ColorEditor.data,
      qt_meta_data_rviz__ColorEditor,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_rviz__ColorEditor.stringdata))
