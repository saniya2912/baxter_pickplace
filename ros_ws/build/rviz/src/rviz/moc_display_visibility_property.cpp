...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_rviz__DisplayVisibilityProperty_t, stringdata) + ofs \
...
const QMetaObject rviz::DisplayVisibilityProperty::staticMetaObject = {
    { &BoolProperty::staticMetaObject, qt_meta_stringdata_rviz__DisplayVisibilityProperty.data,
      qt_meta_data_rviz__DisplayVisibilityProperty,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_rviz__DisplayVisibilityProperty.stringdata))
