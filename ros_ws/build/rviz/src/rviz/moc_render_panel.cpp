...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_rviz__RenderPanel_t, stringdata) + ofs \
...
const QMetaObject rviz::RenderPanel::staticMetaObject = {
    { &QtOgreRenderWindow::staticMetaObject, qt_meta_stringdata_rviz__RenderPanel.data,
      qt_meta_data_rviz__RenderPanel,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_rviz__RenderPanel.stringdata))
