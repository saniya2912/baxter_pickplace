...
def executeTrial(left_dx, left_dy, right_dx, right_dy, w=0, speed=0.5):  
    ...
    spk = raw_input("Done?")
    if spk=='y':
        os.system("espeak 'Nice shot!'")
    elif spk=='n':
        os.system("espeak 'Better luck next time!'")
    elif spk=='w':
        os.system("espeak 'Ok. Who is next!'")
...
while not rospy.is_shutdown():
    ...
    s = 1
    # executeTrial(-0.35, 0.1, 0.05, 0.5, w=-0.97, speed=s)  # left angle
...
################################################################################
    ...
    spk2 = raw_input("Execute trial?")
    if spk2 == 's':
        os.system("espeak 'Stand clear!'") 
    elif spk2 =='h':
        os.system("espeak 'Here we go!'") 
    elif spk2 =='g':
        os.system("espeak 'Get ready!'")  
    elif spk2 =='t':
        os.system("espeak 'Now it is my turn!'") 
    ...
    # TARGET 3
    # executeTrial(-0.3, 0.1, 0.05, 0.5, w=0, speed=s) # left angle
