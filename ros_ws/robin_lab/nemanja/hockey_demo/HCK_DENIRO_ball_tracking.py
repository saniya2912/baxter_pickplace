...
#####################################################################
rospy.init_node("PUSH_DENIRO_ball_tracking")

pub_ball_pos = rospy.Publisher('PUSH_ball_pos', Float32MultiArray, queue_size=1)
pub_ball_img = rospy.Publisher('PUSH_ball_img', Image, queue_size=1)
