// Generated by gencpp from file k2_client/BodyArray.msg
// DO NOT EDIT!
...
template <class ContainerAllocator>
struct IsFixedSize< ::k2_client::BodyArray_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::k2_client::BodyArray_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::k2_client::BodyArray_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::k2_client::BodyArray_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::k2_client::BodyArray_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::k2_client::BodyArray_<ContainerAllocator> const>
  : FalseType
  { };
...
struct MD5Sum< ::k2_client::BodyArray_<ContainerAllocator> >
{
  ...
  {
    return "0d7c3fa42ac7e4033c13152f4de7cea5";
  }

  static const char* value(const ::k2_client::BodyArray_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x0d7c3fa42ac7e403ULL;
  static const uint64_t static_value2 = 0x3c13152f4de7cea5ULL;
};
