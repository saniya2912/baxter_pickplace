...
(cl:defmethod name-val ((m <Face>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pi_face_tracker-msg:name-val is deprecated.  Use pi_face_tracker-msg:name instead.")
  (name m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Face>)))
  ...
  "68b66bc70d3e09dd4a9c8e50d3abf589")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Face)))
  "Returns md5sum for a message object of type 'Face"
  "68b66bc70d3e09dd4a9c8e50d3abf589")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Face>)))
  ...
  (cl:format cl:nil "# Face in 3D space~%int32 id~%string name~%geometry_msgs/Point point~%float32 attention~%# Emotion~%int32 emotion_value~%string emotion_id~%#Temporary~%bool temp_id~%bool recognized~%string recognized_as~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Face)))
  "Returns full string definition for message of type 'Face"
  (cl:format cl:nil "# Face in 3D space~%int32 id~%string name~%geometry_msgs/Point point~%float32 attention~%# Emotion~%int32 emotion_value~%string emotion_id~%#Temporary~%bool temp_id~%bool recognized~%string recognized_as~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%~%"))
