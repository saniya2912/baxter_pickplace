...
if("TRUE" STREQUAL "TRUE")
  set(rviz_SOURCE_PREFIX /home/petar/ros_ws/src/rviz)
  set(rviz_DEVEL_PREFIX /home/petar/ros_ws/devel)
  set(rviz_INSTALL_PREFIX "")
  set(rviz_PREFIX ${rviz_DEVEL_PREFIX})
else()
  set(rviz_SOURCE_PREFIX "")
  set(rviz_DEVEL_PREFIX "")
  set(rviz_INSTALL_PREFIX /home/petar/ros_ws/install)
...
if(NOT "/home/petar/ros_ws/src/rviz/src;/usr/include/eigen3;/usr/include/OGRE;/usr/include " STREQUAL " ")
  set(rviz_INCLUDE_DIRS "")
  set(_include_dirs "/home/petar/ros_ws/src/rviz/src;/usr/include/eigen3;/usr/include/OGRE;/usr/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'rviz' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'D. Hood <dhood@osrfoundation.org>, William Woodall <william@osrfoundation.org>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'rviz' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/petar/ros_ws/src/rviz/${idir}'.  Ask the maintainer 'D. Hood <dhood@osrfoundation.org>, William Woodall <william@osrfoundation.org>' to fix it.")
    endif()
