...
if("TRUE" STREQUAL "TRUE")
  set(openni2_launch_SOURCE_PREFIX /home/petar/ros_ws/src/openni2_launch)
  set(openni2_launch_DEVEL_PREFIX /home/petar/ros_ws/devel)
  ...
  set(openni2_launch_INSTALL_PREFIX /home/petar/ros_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'openni2_launch' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Michael Ferguson <developers@unboundedrobotics.com>, Isaac I. Y. Saito <gm130s@gmail.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'openni2_launch' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/petar/ros_ws/src/openni2_launch/${idir}'.  Ask the maintainer 'Michael Ferguson <developers@unboundedrobotics.com>, Isaac I. Y. Saito <gm130s@gmail.com>' to fix it.")
    endif()
