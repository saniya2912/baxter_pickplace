...
class Face(genpy.Message):
  _md5sum = "68b66bc70d3e09dd4a9c8e50d3abf589"
...
float64 z
"""
  __slots__ = ['id','name','point','attention','emotion_value','emotion_id','temp_id','recognized','recognized_as']
  _slot_types = ['int32','string','geometry_msgs/Point','float32','int32','string','bool','bool','string']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       id,name,point,attention,emotion_value,emotion_id,temp_id,recognized,recognized_as
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_struct_3dfi.pack(_x.point.x, _x.point.y, _x.point.z, _x.attention, _x.emotion_value))
      _x = self.emotion_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.point.x, _x.point.y, _x.point.z, _x.attention, _x.emotion_value,) = _struct_3dfi.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
...
_struct_3dfi = struct.Struct("<3dfi")
